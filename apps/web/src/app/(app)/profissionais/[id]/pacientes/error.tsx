...
export default function PacientesError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
      ...
      <h1 className="text-xl font-semibold text-[var(--ink)] mb-2">Erro ao carregar pacientes</h1>
      <p className="text-sm text-[var(--ink-2)] max-w-xs mb-8">
        Não foi possível carregar a lista de pacientes. Seus dados estão salvos.
      </p>
      <button
        onClick={reset}
